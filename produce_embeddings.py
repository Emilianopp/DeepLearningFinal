...
def get_link_prediction_data_snapshots(dataset_name: str, val_ratio: float, test_ratio: float):
    ...
    full_data  =make_data_dictionaries(full_data_graph_dfs,{},edge_raw_features,node_raw_features,time_varying_features)
...
full_data_unstacked,train_data_unstacked,train_datas,val_datas,test_datas,full_datas= \
